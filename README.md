...
|---------|--------|---------|-------------|
| `antigravity-cli` | `agy` | 1.1.14 | Google's Antigravity CLI - terminal-based AI coding agent |
| `claude-code` | `claude` | 2.1.235 | Claude Code CLI - Anthropic's official CLI for Claude |
| `codex-cli` | `codex` | 0.148.0 | OpenAI Codex CLI tool |
| `crush` | `crush` | 0.89.0 | The glamourous AI coding agent for your favourite terminal |
| `gemini-cli` | `gemini` | 0.55.1 | AI agent that brings the power of Gemini directly into your terminal |
| `opencode` | `opencode` | 1.18.18 | AI coding agent built for the terminal |
