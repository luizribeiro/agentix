...
|---------|--------|---------|-------------|
| `antigravity-cli` | `agy` | 1.0.8 | Google's Antigravity CLI - terminal-based AI coding agent |
| `claude-code` | `claude` | 2.1.177 | Claude Code CLI - Anthropic's official CLI for Claude |
...
| `opencode` | `opencode` | 1.17.7 | AI coding agent built for the terminal |
