...
|---------|--------|---------|-------------|
| `antigravity-cli` | `agy` | 1.2.5 | Google's Antigravity CLI - terminal-based AI coding agent |
| `claude-code` | `claude` | 2.1.275 | Claude Code CLI - Anthropic's official CLI for Claude |
| `codex-cli` | `codex` | 0.154.0 | OpenAI Codex CLI tool |
| `crush` | `crush` | 0.95.0 | The glamourous AI coding agent for your favourite terminal |
| `gemini-cli` | `gemini` | 0.60.0 | AI agent that brings the power of Gemini directly into your terminal |
| `opencode` | `opencode` | 1.18.31 | AI coding agent built for the terminal |
