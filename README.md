...
|---------|--------|---------|-------------|
| `antigravity-cli` | `agy` | 1.2.10 | Google's Antigravity CLI - terminal-based AI coding agent |
| `claude-code` | `claude` | 2.1.281 | Claude Code CLI - Anthropic's official CLI for Claude |
...
| `roborev` | `roborev` | 0.68.2 | Continuous code review daemon for AI coding agents |
