...
|---------|--------|---------|-------------|
| `antigravity-cli` | `agy` | 1.2.6 | Google's Antigravity CLI - terminal-based AI coding agent |
| `claude-code` | `claude` | 2.1.276 | Claude Code CLI - Anthropic's official CLI for Claude |
