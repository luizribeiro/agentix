...
|---------|--------|---------|---------|-------------|
| `codex-cli` | `codex` | 0.71.0 | Unfree | OpenAI Codex CLI tool |
| `claude-code` | `claude` | 2.0.68 | Unfree | Anthropic's official CLI for Claude |
| `gemini-cli` | `gemini` | 0.20.2 | Apache 2.0 | Google's Gemini AI CLI |
