...
|---------|--------|---------|-------------|
| `codex-cli` | `codex` | 0.114.0 | OpenAI Codex CLI tool |
| `claude-code` | `claude` | 2.1.72 | Anthropic's official CLI for Claude |
| `gemini-cli` | `gemini` | 0.33.0 | Google's Gemini AI CLI |
| `crush` | `crush` | 0.22.1 | Charmbracelet's AI coding agent |
| `opencode` | `opencode` | 1.2.24 | Anomaly's AI coding agent |
| `pi` | `pi` | 0.57.1 | pi.dev minimal terminal-based coding agent |
