...
| `claude-code` | `claude` | 2.1.195 | Claude Code CLI - Anthropic's official CLI for Claude |
| `codex-cli` | `codex` | 0.142.3 | OpenAI Codex CLI tool |
...
| `opencode` | `opencode` | 1.17.11 | AI coding agent built for the terminal |
