...
|---------|--------|---------|---------|-------------|
| `codex-cli` | `codex` | 0.89.0 | Unfree | OpenAI Codex CLI tool |
| `claude-code` | `claude` | 2.1.19 | Unfree | Anthropic's official CLI for Claude |
| `gemini-cli` | `gemini` | 0.25.1 | Apache 2.0 | Google's Gemini AI CLI |
