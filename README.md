...
| `gemini-cli` | `gemini` | 0.53.0 | AI agent that brings the power of Gemini directly into your terminal |
| `opencode` | `opencode` | 1.18.10 | AI coding agent built for the terminal |
