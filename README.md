...
|---------|--------|---------|-------------|
| `antigravity-cli` | `agy` | 1.1.3 | Google's Antigravity CLI - terminal-based AI coding agent |
| `claude-code` | `claude` | 2.1.211 | Claude Code CLI - Anthropic's official CLI for Claude |
| `codex-cli` | `codex` | 0.144.4 | OpenAI Codex CLI tool |
...
| `opencode` | `opencode` | 1.18.2 | AI coding agent built for the terminal |
