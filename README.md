...
| `crush` | `crush` | 0.65.2 | Charmbracelet's AI coding agent |
| `opencode` | `opencode` | 1.14.33 | Anomaly's AI coding agent |
| `pi` | `pi` | 0.72.1 | pi.dev minimal terminal-based coding agent |
