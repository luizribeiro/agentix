...
|---------|--------|---------|-------------|
| `antigravity-cli` | `agy` | 1.2.8 | Google's Antigravity CLI - terminal-based AI coding agent |
| `claude-code` | `claude` | 2.1.280 | Claude Code CLI - Anthropic's official CLI for Claude |
...
| `gemini-cli` | `gemini` | 0.60.0 | AI agent that brings the power of Gemini directly into your terminal |
...
| `roborev` | `roborev` | 0.68.1 | Continuous code review daemon for AI coding agents |
