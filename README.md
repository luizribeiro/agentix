...
| `claude-code` | `claude` | 2.1.162 | Claude Code CLI - Anthropic's official CLI for Claude |
...
| `gemini-cli` | `gemini` | 0.45.0 | AI agent that brings the power of Gemini directly into your terminal |
