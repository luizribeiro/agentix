...
|---------|--------|---------|-------------|
| `antigravity-cli` | `agy` | 1.1.19 | Google's Antigravity CLI - terminal-based AI coding agent |
| `claude-code` | `claude` | 2.1.241 | Claude Code CLI - Anthropic's official CLI for Claude |
| `codex-cli` | `codex` | 0.149.0 | OpenAI Codex CLI tool |
...
| `opencode` | `opencode` | 1.18.21 | AI coding agent built for the terminal |
| `pi` | `pi` | 0.84.2 | pi.dev - A minimal terminal-based coding agent |
