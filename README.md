...
|---------|--------|---------|---------|-------------|
| `codex-cli` | `codex` | 0.92.0 | Unfree | OpenAI Codex CLI tool |
| `claude-code` | `claude` | 2.1.22 | Unfree | Anthropic's official CLI for Claude |
| `gemini-cli` | `gemini` | 0.26.0 | Apache 2.0 | Google's Gemini AI CLI |
