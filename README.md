...
|---------|--------|---------|-------------|
| `antigravity-cli` | `agy` | 1.1.22 | Google's Antigravity CLI - terminal-based AI coding agent |
| `claude-code` | `claude` | 2.1.251 | Claude Code CLI - Anthropic's official CLI for Claude |
| `codex-cli` | `codex` | 0.151.0 | OpenAI Codex CLI tool |
| `crush` | `crush` | 0.91.2 | The glamourous AI coding agent for your favourite terminal |
| `gemini-cli` | `gemini` | 0.57.0 | AI agent that brings the power of Gemini directly into your terminal |
| `opencode` | `opencode` | 1.18.25 | AI coding agent built for the terminal |
| `pi` | `pi` | 0.84.4 | pi.dev - A minimal terminal-based coding agent |
