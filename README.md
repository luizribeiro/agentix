...
|---------|--------|---------|-------------|
| `antigravity-cli` | `agy` | 1.2.7 | Google's Antigravity CLI - terminal-based AI coding agent |
| `claude-code` | `claude` | 2.1.278 | Claude Code CLI - Anthropic's official CLI for Claude |
...
| `pi` | `pi` | 0.87.0 | pi.dev - A minimal terminal-based coding agent |
| `roborev` | `roborev` | 0.68.0 | Continuous code review daemon for AI coding agents |
