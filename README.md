...
| `claude-code` | `claude` | 2.1.83 | Anthropic's official CLI for Claude |
| `gemini-cli` | `gemini` | 0.35.0 | Google's Gemini AI CLI |
| `crush` | `crush` | 0.22.1 | Charmbracelet's AI coding agent |
| `opencode` | `opencode` | 1.3.2 | Anomaly's AI coding agent |
