...
|---------|--------|---------|-------------|
| `antigravity-cli` | `agy` | 1.1.5 | Google's Antigravity CLI - terminal-based AI coding agent |
| `claude-code` | `claude` | 2.1.216 | Claude Code CLI - Anthropic's official CLI for Claude |
