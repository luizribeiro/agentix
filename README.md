...
| `claude-code` | `claude` | 2.1.183 | Claude Code CLI - Anthropic's official CLI for Claude |
| `codex-cli` | `codex` | 0.141.0 | OpenAI Codex CLI tool |
...
| `opencode` | `opencode` | 1.17.8 | AI coding agent built for the terminal |
