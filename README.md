...
|---------|--------|---------|-------------|
| `antigravity-cli` | `agy` | 1.1.17 | Google's Antigravity CLI - terminal-based AI coding agent |
| `claude-code` | `claude` | 2.1.238 | Claude Code CLI - Anthropic's official CLI for Claude |
...
| `opencode` | `opencode` | 1.18.19 | AI coding agent built for the terminal |
