...
|---------|--------|---------|-------------|
| `antigravity-cli` | `agy` | 1.0.6 | Google's Antigravity CLI - terminal-based AI coding agent |
...
| `gemini-cli` | `gemini` | 0.45.2 | AI agent that brings the power of Gemini directly into your terminal |
| `opencode` | `opencode` | 1.16.2 | AI coding agent built for the terminal |
