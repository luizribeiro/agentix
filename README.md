...
|---------|--------|---------|-------------|
| `antigravity-cli` | `agy` | 1.1.1 | Google's Antigravity CLI - terminal-based AI coding agent |
| `claude-code` | `claude` | 2.1.206 | Claude Code CLI - Anthropic's official CLI for Claude |
| `codex-cli` | `codex` | 0.144.1 | OpenAI Codex CLI tool |
...
| `opencode` | `opencode` | 1.17.18 | AI coding agent built for the terminal |
