...
|---------|--------|---------|---------|-------------|
| `codex-cli` | `codex` | 0.73.0 | Unfree | OpenAI Codex CLI tool |
| `claude-code` | `claude` | 2.0.71 | Unfree | Anthropic's official CLI for Claude |
| `gemini-cli` | `gemini` | 0.21.1 | Apache 2.0 | Google's Gemini AI CLI |
