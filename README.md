...
|---------|--------|---------|---------|-------------|
| `codex-cli` | `codex` | 0.66.0 | Unfree | OpenAI Codex CLI tool |
| `claude-code` | `claude` | 2.0.64 | Unfree | Anthropic's official CLI for Claude |
| `gemini-cli` | `gemini` | 0.20.0 | Apache 2.0 | Google's Gemini AI CLI |
