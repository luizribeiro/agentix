...
| `claude-code` | `claude` | 2.0.54 | Unfree | Anthropic's official CLI for Claude |
| `gemini-cli` | `gemini` | 0.18.4 | Apache 2.0 | Google's Gemini AI CLI |
| `crush` | `crush` | 0.19.1 | MIT | Charmbracelet's AI coding agent |
