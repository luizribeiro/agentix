...
|---------|--------|---------|-------------|
| `codex-cli` | `codex` | 0.128.0 | OpenAI Codex CLI tool |
| `claude-code` | `claude` | 2.1.126 | Anthropic's official CLI for Claude |
| `gemini-cli` | `gemini` | 0.40.1 | Google's Gemini AI CLI |
| `crush` | `crush` | 0.64.0 | Charmbracelet's AI coding agent |
| `opencode` | `opencode` | 1.14.31 | Anomaly's AI coding agent |
| `pi` | `pi` | 0.71.0 | pi.dev minimal terminal-based coding agent |
