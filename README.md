...
|---------|--------|---------|-------------|
| `antigravity-cli` | `agy` | 1.0.12 | Google's Antigravity CLI - terminal-based AI coding agent |
| `claude-code` | `claude` | 2.1.191 | Claude Code CLI - Anthropic's official CLI for Claude |
| `codex-cli` | `codex` | 0.142.1 | OpenAI Codex CLI tool |
| `crush` | `crush` | 0.75.0 | The glamourous AI coding agent for your favourite terminal |
| `gemini-cli` | `gemini` | 0.47.0 | AI agent that brings the power of Gemini directly into your terminal |
| `opencode` | `opencode` | 1.17.10 | AI coding agent built for the terminal |
