...
|---------|--------|---------|-------------|
| `antigravity-cli` | `agy` | 1.2.2 | Google's Antigravity CLI - terminal-based AI coding agent |
| `claude-code` | `claude` | 2.1.269 | Claude Code CLI - Anthropic's official CLI for Claude |
| `codex-cli` | `codex` | 0.154.0 | OpenAI Codex CLI tool |
| `crush` | `crush` | 0.94.1 | The glamourous AI coding agent for your favourite terminal |
