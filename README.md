...
|---------|--------|---------|-------------|
| `antigravity-cli` | `agy` | 1.2.4 | Google's Antigravity CLI - terminal-based AI coding agent |
| `claude-code` | `claude` | 2.1.274 | Claude Code CLI - Anthropic's official CLI for Claude |
