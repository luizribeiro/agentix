...
|---------|--------|---------|---------|-------------|
| `codex-cli` | `codex` | 0.79.0 | Unfree | OpenAI Codex CLI tool |
| `claude-code` | `claude` | 2.0.76 | Unfree | Anthropic's official CLI for Claude |
| `gemini-cli` | `gemini` | 0.22.5 | Apache 2.0 | Google's Gemini AI CLI |
