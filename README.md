...
|---------|--------|---------|-------------|
| `antigravity-cli` | `agy` | 1.0.11 | Google's Antigravity CLI - terminal-based AI coding agent |
| `claude-code` | `claude` | 2.1.190 | Claude Code CLI - Anthropic's official CLI for Claude |
| `codex-cli` | `codex` | 0.142.0 | OpenAI Codex CLI tool |
