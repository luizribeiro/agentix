...
| `crush` | `crush` | 0.65.3 | Charmbracelet's AI coding agent |
| `opencode` | `opencode` | 1.14.34 | Anomaly's AI coding agent |
| `pi` | `pi` | 0.73.0 | pi.dev minimal terminal-based coding agent |
