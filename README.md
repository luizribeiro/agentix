...
| `claude-code` | `claude` | 2.1.104 | Anthropic's official CLI for Claude |
| `gemini-cli` | `gemini` | 0.37.1 | Google's Gemini AI CLI |
| `crush` | `crush` | 0.22.1 | Charmbracelet's AI coding agent |
| `opencode` | `opencode` | 1.4.3 | Anomaly's AI coding agent |
| `pi` | `pi` | 0.66.1 | pi.dev minimal terminal-based coding agent |
