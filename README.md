...
| `claude-code` | `claude` | 2.1.221 | Claude Code CLI - Anthropic's official CLI for Claude |
| `codex-cli` | `codex` | 0.146.0 | OpenAI Codex CLI tool |
...
| `opencode` | `opencode` | 1.18.13 | AI coding agent built for the terminal |
