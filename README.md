...
|---------|--------|---------|-------------|
| `antigravity-cli` | `agy` | 1.0.10 | Google's Antigravity CLI - terminal-based AI coding agent |
| `claude-code` | `claude` | 2.1.186 | Claude Code CLI - Anthropic's official CLI for Claude |
