...
|---------|--------|---------|-------------|
| `antigravity-cli` | `agy` | 1.1.23 | Google's Antigravity CLI - terminal-based AI coding agent |
| `claude-code` | `claude` | 2.1.257 | Claude Code CLI - Anthropic's official CLI for Claude |
